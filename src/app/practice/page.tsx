...
export default function Home() {
	...
	return (
		<div className="flex justify-end">
			...
			/>
			<div
				className={`relative bg-black text-white rounded-l-2xl 
        ...
        `}
					...
					<div className="my-2">
						<button
							...
							onClick={(e) => {
								e.preventDefault();
								let contentTokens =
									document.getElementById("content-tokens");

								toast.success("Submitted!", {
									position: "bottom-right",
								});

								const contentToSend = data.replaceAll(
									previousData,
									""
								);
				...
				<div
					id="content-tokens"
					className={`${assist ? "px-16" : ""} text-md`}
				></div>
			</div>
		</div>
	);
